...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.NokiaTasCallDirectionApi.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://mn.developer.nokia.com/tasseeAPI
     */
    this.basePath = 'http://mn.developer.nokia.com/tasseeAPI'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'nokia_mn_api_auth': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
    };
    /**
