...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.NotifyURL();
  });
  ...
  describe('NotifyURL', function() {
    it('should create an instance of NotifyURL', function() {
      // uncomment below and update the code to test NotifyURL
      //var instane = new NokiaTasCallDirectionApi.NotifyURL();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.NotifyURL);
    });
