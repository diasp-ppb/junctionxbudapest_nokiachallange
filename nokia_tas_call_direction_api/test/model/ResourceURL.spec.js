...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.ResourceURL();
  });
  ...
  describe('ResourceURL', function() {
    it('should create an instance of ResourceURL', function() {
      // uncomment below and update the code to test ResourceURL
      //var instane = new NokiaTasCallDirectionApi.ResourceURL();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.ResourceURL);
    });
