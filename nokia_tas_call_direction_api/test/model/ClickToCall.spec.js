...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.ClickToCall();
  });
  ...
  describe('ClickToCall', function() {
    it('should create an instance of ClickToCall', function() {
      // uncomment below and update the code to test ClickToCall
      //var instane = new NokiaTasCallDirectionApi.ClickToCall();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.ClickToCall);
    });

    it('should have the property callSessionInformation (base name: "callSessionInformation")', function() {
      // uncomment below and update the code to test the property callSessionInformation
      //var instane = new NokiaTasCallDirectionApi.ClickToCall();
