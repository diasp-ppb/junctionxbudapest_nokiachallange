...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.CallSessionInformation();
  });
  ...
  describe('CallSessionInformation', function() {
    it('should create an instance of CallSessionInformation', function() {
      // uncomment below and update the code to test CallSessionInformation
      //var instane = new NokiaTasCallDirectionApi.CallSessionInformation();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.CallSessionInformation);
    });
