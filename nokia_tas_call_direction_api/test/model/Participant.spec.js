...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.Participant();
  });
  ...
  describe('Participant', function() {
    it('should create an instance of Participant', function() {
      ...
      //var instane = new NokiaTasCallDirectionApi.Participant();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.Participant);
    });
