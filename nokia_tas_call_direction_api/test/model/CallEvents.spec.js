...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.CallEvents();
  });
  ...
  describe('CallEvents', function() {
    it('should create an instance of CallEvents', function() {
      // uncomment below and update the code to test CallEvents
      //var instane = new NokiaTasCallDirectionApi.CallEvents();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.CallEvents);
    });
