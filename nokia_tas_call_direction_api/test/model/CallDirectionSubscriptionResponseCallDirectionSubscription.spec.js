...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NokiaTasCallDirectionApi.CallDirectionSubscriptionResponseCallDirectionSubscription();
  });
  ...
  describe('CallDirectionSubscriptionResponseCallDirectionSubscription', function() {
    it('should create an instance of CallDirectionSubscriptionResponseCallDirectionSubscription', function() {
      // uncomment below and update the code to test CallDirectionSubscriptionResponseCallDirectionSubscription
      //var instane = new NokiaTasCallDirectionApi.CallDirectionSubscriptionResponseCallDirectionSubscription();
      //expect(instance).to.be.a(NokiaTasCallDirectionApi.CallDirectionSubscriptionResponseCallDirectionSubscription);
    });
